//-----------------------------------------------------------------------
// <copyright file="SuspensionManager.cs" company="FH Wr.Neustadt">
...
namespace NumberRecognizer.App.Common
{
    ...
    internal sealed class SuspensionManager
    {
        ...
        /// <summary>
        /// The frame session base key property.
        /// </summary>
        ...
        public static async Task SaveAsync()
        {
            try
            {
                ...
                // Get an output randomAccessStream for the SessionState storageFile and write the state asynchronously
        ...
        public static async Task RestoreAsync(string sessionBaseKey = null)
        {
            ...
            try
            {
                // Get the input randomAccessStream for the SessionState storageFile
        ...
        /// <summary>
        /// Restores the state of the frame navigation.
        /// </summary>
        ...
        /// <summary>
        /// Saves the state of the frame navigation.
        /// </summary>
        /// <param name="frame">The frame.</param>
